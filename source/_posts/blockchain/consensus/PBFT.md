...
PBFT 容忍无效或者恶意节点数：f，为了保障整个系统可以正常运转，需要有 2f+1 个正常节点，系统的总节点数为：|R| = 3f + 1。也就是说，PBFT 算法可以容忍小于 1/3 个无效或者恶意节点。也就是说在超过 1/3 ｜ R ｜ 个节点确认之后，就认为是没有问题的。如以下代码 **131** 行所展现。
